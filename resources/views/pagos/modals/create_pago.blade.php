    ...
    <div class="modal-content">
      <div class="modal-header bg-navy">
        ...
        <h4 class="modal-title">
            <i class="fa fa-arrow-right"></i> Nuevo Pago
            <span class="pull-right">
                <i class="fa fa-spinner fa-pulse" id="icon_load_venta" style="display: none;"></i>
            </span>
        </h4>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group col-lg-3">
            ...
            <input type="text" class="form-control" id="total_deuda" readonly="" name="total_deuda" required="">
        </div>
